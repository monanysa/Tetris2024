...
class GameGrid:
    ...
    def display(self):
        ...
        if self.recent_tetromino is not None and self.next_tetromino is not None:
            self.recent_tetromino.draw()
    ...
    def change_speed(self):
        if self.last_updated > 500 and self.game_speed >= 50:
            ...
            print("Former Speed", self.game_speed)
            self.game_speed -= change_rate
            print("Current Speed", self.game_speed)
